...
def worker_result() -> WorkerResult:
    return WorkerResult(
        implementation_plan=ImplementationPlan(
            ...
            design_guidelines={
                "artistic_direction": "One clean procedural direction.",
                "concept_twist": "Original adapter fixture.",
                "structure": "pattern",
                "body_strategy": "Reads at four cells and while the snake grows and turns.",
