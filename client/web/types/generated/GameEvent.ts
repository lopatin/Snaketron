...
export type GameEvent = { "SnakeTurned": { snake_id: number, direction: Direction, } } | { "SnakeDied": { snake_id: number, } } | { "FoodSpawned": { position: Position, } } | { "FoodEaten": { snake_id: number, position: Position, } } | { "Snapshot": { game_state: GameState, } } | { "CommandScheduled": { command_message: GameCommandMessage, } } | { "CommandScheduledV2": { command_id: ClientCommandIdentityV2, command_message: GameCommandMessage, 
/**
