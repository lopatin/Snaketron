 ...
 */
export type SkinSummary = { skinId: number, reference: string, name: string, kind: SkinKind, namespace: SkinNamespace, publication: Publication, creatorUserId: number, creatorUsername: string | null, priceBux: number,
/**
