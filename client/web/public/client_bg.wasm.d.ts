...
export const render_game: (a: number, b: number, c: any, d: number, e: number) => [number, number];
export const __wbg_gameclient_free: (a: number, b: number) => void;
export const gameclient_new: (a: number, b: bigint) => number;
export const gameclient_newFromState: (a: number, b: number, c: number) => [number, number, number];
...
export const gameclient_rebuildPredictedState: (a: number, b: bigint) => [number, number];
...
export const gameclient_getCommittedTick: (a: number) => number;
export const gameclient_getPredictedTick: (a: number) => number;
export const gameclient_getGameId: (a: number) => number;
export const gameclient_getSnakeIdForUser: (a: number, b: number) => number;
