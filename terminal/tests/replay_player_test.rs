use anyhow::Result;
use common::{GameState, GameEvent, GameEventMessage, GameCommand, CommandId, GameCommandMessage, Direction, GameStatus};
...
fn test_replay_player_with_tick_forward() -> Result<()> {
    ...
    let metadata = ReplayMetadata {
        players: vec![
            PlayerInfo { user_id: 1, snake_id: 0, username: "Player1".to_string() },
            PlayerInfo { user_id: 2, snake_id: 1, username: "Player2".to_string() },
        ],
