...
MELODY = [
    ...
    # The last note the tune plays before the end slate. It was the THIRD of
    # the chord an octave up (1, 5), which hangs — the track built well and
    # then asked a question nobody answered. The fifth, low, settles without
    # fully closing: it signs off rather than either reaching or resolving
    # hard. Steps 6 and 10 of this bar fall past the fadewhite and never
    # sound; only step 0 is heard.
    (4, 0, 2, 4), (4, 6, 0, 5), (4, 10, 2, 5),
